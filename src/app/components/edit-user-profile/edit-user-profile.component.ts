...
//selectFile(event) { //Angular 8
  ...
  constructor(private userService: UserService, private loginService: LoginService, private router: Router, private imageService: ImageService) {
  ...
  resetInputFields() {
    ...
    this.imageInput = this.currentUser.image;
